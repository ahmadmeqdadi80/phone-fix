...
const sampleData = {
  ...
  repairs: [
    ...
    { id: 'r3', customerId: 'c3', deviceType: 'Xiaomi', deviceModel: 'Redmi Note 13 Pro', problem: 'الجهاز لا يشتغل نهائياً', status: 'DIAGNOSING', deposit: 0, paidAmount: 0, debt: 0, entryDate: '2024-02-26', receivedAt: '2024-02-26', createdAt: '2024-02-26', updatedAt: new Date().toISOString() },
    { id: 'r4', customerId: 'c4', deviceType: 'iPhone', deviceModel: 'iPhone 12', problem: 'الشاحن لا يعمل - المنفذ متسخ', status: 'COMPLETED', maintenanceCost: 15, finalCost: 40, deposit: 0, paidAmount: 0, debt: 0, entryDate: '2024-02-26', receivedAt: '2024-02-26', completedAt: '2024-02-26', createdAt: '2024-02-26', updatedAt: new Date().toISOString() },
    { id: 'r5', customerId: 'c1', deviceType: 'Huawei', deviceModel: 'Mate 50 Pro', problem: 'الكاميرا الخلفية لا تعمل', status: 'WAITING_PARTS', maintenanceCost: 80, finalCost: 180, deposit: 50, paidAmount: 0, debt: 0, entryDate: '2024-02-24', receivedAt: '2024-02-24', createdAt: '2024-02-24', updatedAt: new Date().toISOString() }
  ] as Repair[],
  inventory: [
